...
We modify the structure for single player game and rlcard3 package, and fix some bugs for loss calculation.
...
class DeepCFR():
    ...
    def __init__(self,
        ...
        Args:
            ...
            env (rlcard3.env): for training (traverse)
    ...
    def _traverse_game_tree(self, state, player, count = 0):
        ...
        Args:
            state (dict): Current rlcard3 game state.
