...
from rlcard3.games.limitholdem.game import LimitholdemGame as Game
...
class LimitholdemEnv(Env):
    ...
    def __init__(self, config):
        ...
        with open(os.path.join(rlcard3.__path__[0], 'games/limitholdem/card2index.json'), 'r') as file:
